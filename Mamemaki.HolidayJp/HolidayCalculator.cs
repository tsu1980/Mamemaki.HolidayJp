    ...
    public class HolidayCalculator
    {
        ...
        static HolidayCalculator()
        {
            Rules = new List<HolidayRule>
            {
                ...
                new HolidayRule_Fixed(new HolidayInfo(HolidayKind.National, "海の日", "Marine Day"), 7, 22, 2021, 2021),
                new HolidayRule_HappyMonday(new HolidayInfo(HolidayKind.National, "海の日", "Marine Day"), 7, 3, 2022, 9999),
                ...
                new HolidayRule_Fixed(new HolidayInfo(HolidayKind.National, "山の日", "Mountain Day"), 8, 8, 2021, 2021),
                new HolidayRule_Fixed(new HolidayInfo(HolidayKind.National, "山の日", "Mountain Day"), 8, 11, 2022, 9999),
                ...
                new HolidayRule_Fixed(new HolidayInfo(HolidayKind.National, "スポーツの日", "Health and Sports Day"), 7, 23, 2021, 2021),
                new HolidayRule_HappyMonday(new HolidayInfo(HolidayKind.National, "スポーツの日", "Health and Sports Day"), 10, 2, 2022, 9999),
